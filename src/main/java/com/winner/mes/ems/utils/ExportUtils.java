...
import com.winner.mes.ems.constant.JasperConstant;
...
// new JREmptyDataSource());
    File sourceFile = new File(JasperConstant.REPORTS + name + ".jasper");
  ...
  public static void fill(String name, JasperReport jasperReport) throws JRException {
    ...
    File destFile = new File(JasperConstant.PRINTS, jasperReport.getName() + ".jrprint");
  ...
  */
  public static void print(String name) throws JRException {
    long start = System.currentTimeMillis();
    JasperPrintManager.printReport(JasperConstant.PRINTS + name + ".jrprint", true);
  ...
  */
  public static void pdf(String name) throws JRException {
    long start = System.currentTimeMillis();
    JasperExportManager.exportReportToPdfFile(JasperConstant.PRINTS + name + ".jrprint");
  ...
  */
  public static void xml(String name) throws JRException {
    long start = System.currentTimeMillis();
    JasperExportManager.exportReportToXmlFile(JasperConstant.PRINTS + name + ".jrprint", false);
  ...
  */
  public static void xmlEmbed(String name) throws JRException {
    long start = System.currentTimeMillis();
    JasperExportManager.exportReportToXmlFile(JasperConstant.PRINTS + name + ".jrprint", true);
    System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
  }
  ...
  */
  public static void html(String name) throws JRException {
    long start = System.currentTimeMillis();
    JasperExportManager.exportReportToHtmlFile(JasperConstant.PRINTS + name + ".jrprint");
  ...
  private static void export(JRAbstractExporter exporter, String name, String type, String msg)
      throws JRException {
    long start = System.currentTimeMillis();
    File sourceFile = new File(JasperConstant.PRINTS + name + ".jrprint");
    JasperPrint jasperPrint = (JasperPrint) JRLoader.loadObject(sourceFile);
    File destFile = new File(JasperConstant.DIST, jasperPrint.getName() + type);
